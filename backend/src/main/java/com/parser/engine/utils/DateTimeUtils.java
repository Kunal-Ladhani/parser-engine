...
public class DateTimeUtils {
	...
	/**
	 * Get current LocalDateTime (without timezone info)
	 */
	 ...
	 */
	public static String formatLocalDateTimeForDisplay(LocalDateTime localDateTime) {
		return localDateTime.format(DISPLAY_FORMATTER);
	}

	/**
	 * Format LocalDateTime for API responses (without timezone)
	 */
	public static String formatLocalDateTimeForApi(LocalDateTime localDateTime) {
